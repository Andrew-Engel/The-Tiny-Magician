...
{
    [SerializeField] float equipCoroutineWaitTime = 0.8f;
    Sneaking sneaking;
   ...
   public PuppetMasterProp puppetMasterProp;
    ...
    private void OnSwitchSpells()
    {
        ...
        if (holdingGrenade) StartCoroutine(UnequipGrenade());
    }
    ...
    public IEnumerator EquipGrenade()
    {
        ...
        StartCoroutine(StandStill(equipCoroutineWaitTime));
        yield return new WaitForSeconds(equipCoroutineWaitTime);
