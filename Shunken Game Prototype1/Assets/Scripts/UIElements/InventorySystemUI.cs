...
public class InventorySystemUI : MonoBehaviour
{
   ...
   public Dictionary<string, GameObject> itemUI = new Dictionary<string, GameObject>();
    ...
    void Start()
    {
       ...
       // itemListParent = GameObject.Find("Inventory Potions and Medkits Items List Parent").GetComponent<Transform>();
    }
    ...
    public void AddItem(string item, int itemLevel)
    {
        ...
        switch (item)
        {
            ...
            case ("Mana"):
                {
                    if (_audio == null) _audio = _audio = GetComponent<AudioSource>();
        ...
        if (newItem)
        {
            if (itemListParent == null) itemListParent = GameObject.Find("Inventory Potions and Medkits Items List Parent").GetComponent<Transform>();
