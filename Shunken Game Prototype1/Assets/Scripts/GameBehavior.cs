...
public class GameBehavior : MonoBehaviour //Imanager
{
   ...
   public Volume volume;
    ...
    private void Awake()
    {
        openingCutscenePlayer.loopPointReached += OnEndOfCutScene;
    }
    void Start ()
    {
       ...
       // Cursor.visible = false;
        ...
        if (openingCutscenePlayer == null) FindObjectOfType<AudioManager>().Play(backgroundMusicTitle);
    ...
    void OnEndOfCutScene(UnityEngine.Video.VideoPlayer vp)
    {
    ...
    {
        if (hud == null) hud = GameObject.Find("PlayTime HUD");
        hud.SetActive(false);
