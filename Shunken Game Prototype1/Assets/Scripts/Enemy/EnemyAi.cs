...
{
    public static bool enemyAggroEnabled = true;
   ...
   // private LineRenderer laserLine;
    ...
    //Send Event for first time noticing player (for Boss fights)
    public event EventHandler onInitialAggro;
   ...
   private void Patroling()
    ...
    {
        if (agent.enabled&&enemyAggroEnabled)
        {
            ...
            {
                aggroTriggered = true;
                if (onInitialAggro!=null)
                onInitialAggro(this, EventArgs.Empty);
            }
            switch (enemyType)
            {
                case ("Centipede"):
   ...
   private void CentipedeAttack()
    ...
    void Update()
    {
        ...
        if (playerInSightRange && !playerInAttackRange && playerInSight&&!stayInPlace && enemyAggroEnabled)
        {
       ...
       if (playerInAttackRange && playerInSightRange&&!stayInPlace&&enemyAggroEnabled)
        {
