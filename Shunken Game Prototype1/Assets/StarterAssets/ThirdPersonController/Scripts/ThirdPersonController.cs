...
namespace StarterAssets
{
	...
	public class ThirdPersonController : MonoBehaviour
	{
		...
		[SerializeField] bool _hasAnimator;
		...
		private void CameraRotation()
		{
			...
			{
				_cinemachineTargetYaw += _input.look.x * Time.deltaTime * lookSensitivity;
				_cinemachineTargetPitch += _input.look.y * Time.deltaTime * lookSensitivity;
            ...
            {
				this.transform.rotation = CinemachineCameraTarget.transform.rotation;
		...
		private void Move()
		{
			...
			if (stamina ==null) stamina = GameObject.Find("GameManager").GetComponent<StaminaBar>();
			...
			if (_input.move == Vector2.zero || StayInPlace.stayInPlace )
			{
				targetSpeed = 0.0f;
